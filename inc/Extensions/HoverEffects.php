...
class HoverEffects extends ExtensionsController {
	public function extensions_register() {
		...
		add_shortcode( 'rdextkc_hovereffects', array( $this, 'rdextkc_hovereffects_func' ) );
		add_action( 'init', array( $this, 'hovereffect' ) );
	...
	function rdextkc_hovereffects_func( $atts, $content = null ) {
